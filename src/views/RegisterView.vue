  ...
  <div class="form-wrap">
    <form class="register">
      <p class="login-register">
        Ja tens compte a Ràdio Farró?
        <router-link class="router-link" :to="{ name: 'Login' }">Accedeix</router-link>
      </p>
      <h2>Crea el teu compte a Ràdio Farró!</h2>
      <div class="inputs">
        <div class="input">
        ...
        <div class="input">
          <input type="text" placeholder="cognom" v-model="lastName">
          <div class="icon email-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
              <path
                d="M5 20V19C5 16.2386 7.23858 14 10 14H14C16.7614 14 19 16.2386 19 19V20M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z"
        ...
        <div class="input">
          <input type="text" placeholder="nom d'usuari" v-model="userName">
          <div class="icon email-icon">
            <svg xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" fill="none">
              <path
                d="M5 20V19C5 16.2386 7.23858 14 10 14H14C16.7614 14 19 16.2386 19 19V20M16 7C16 9.20914 14.2091 11 12 11C9.79086 11 8 9.20914 8 7C8 4.79086 9.79086 3 12 3C14.2091 3 16 4.79086 16 7Z"
        ...
        <div class="input">
          <input type="password" placeholder="contrasenya" v-model="password">
      ...
      <button @click.prevent="register">Entra</button>
  ...
  methods: {
    async register() {
      if (
        ...
        this.error = true;
        this.errorMsg = "Si us plau, omple tots els camps!";
        return;
      }
    },
  },
...
.form-wrap {
  ...
  .background {
    ...
    background-image: url("../assets/images/rf01.jpeg");
    width: 100%;
    height: 100%;
